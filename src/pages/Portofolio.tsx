...
import { Text, Separator, Flex, Image, Span, Grid, Box } from "@chakra-ui/react"
import {
  DialogBody,
  DialogCloseTrigger,
  DialogContent,
...
export default function Portofolio(){
    return(
      <Flex direction={{base:"column"}} paddingX={{base:"16px", md:"300px"}} id="portofolio">
        <Flex  direction={{base:"column"}} paddingY={{base:"30px"}}>
          <Text color={"white"} textStyle="3xl" > Portofolio </Text>
          <Flex direction={{base:"column"}}> 
              <Flex direction={{base:"row", md:"column"}} justifyContent={"center"}>
                    <Grid templateColumns={{base:"repeat(1, 1fr)", md:"repeat(3, 1fr)"}}gap="8" >

                      <DialogRoot size="cover" placement="center"  motionPreset="slide-in-bottom" scrollBehavior="inside"  >
                          ...
                          <DialogTrigger asChild  >
                                ...
                                <Box justifyItems={"center"} marginTop={"10px"} rounded={"lg"} backgroundColor={"gray.600"} padding={{base:"8px", md:"10px"}} _hover={{backgroundColor:"white",color:"black"}} color={"white"} minWidth={{base:"102px", md:"200px"}}>
                                    ...
                                    <Text  fontSize={{base:"16px", md:"14px"}} textAlign={"left"}>Technology:React, Express,and AWS
                                    </Text>
                                    </Flex>
                                </Box>
                        ...
                        <DialogContent>
                          <DialogHeader>
                                <DialogTitle fontWeight={700} fontSize={30} textAlign={"center"}>
                                  E-commerce : Uniqla Website 
                                </DialogTitle>
                                <DialogCloseTrigger />
                          </DialogHeader >
                          <DialogBody>
                              <Text as={Span}  fontWeight={600}fontSize={20}>Situation</Text>
                              ...
                              <Text as={Span}  fontWeight={600}fontSize={20}>Task</Text>
                              <Text textAlign="justify">
                              ...
                              <Text as={Span} fontWeight={600}fontSize={20}>Action</Text>
                              <Text textAlign="justify">
                              ...
                              <Text as={Span} fontWeight={600}fontSize={20}>Result</Text>
                     ...
                     <DialogRoot size="cover" placement="center"  motionPreset="slide-in-bottom" scrollBehavior="inside"  >
                                ...
                                <DialogTrigger asChild  >
                                      ...
                                      <Box justifyItems={"center"} marginTop={"10px"} rounded={"lg"} backgroundColor={"gray.600"} padding={{base:"8px", md:"10px"}} _hover={{backgroundColor:"white",color:"black"}} color={"white"} minWidth={{base:"102px", md:"200px"}}>
                                          ...
                                          <Text  fontSize={{base:"16px", md:"14px"}} textAlign={"left"}>Technology:React, Express, Node.js, AWS,and PostgreSQL
                                          </Text>
                                          </Flex>
                                      </Box>
